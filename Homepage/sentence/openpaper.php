...
<body>
        ...
        <aside class="right">
            ...
            <div class="input-note">
                <form id="my-form" method="POST" action="openpaper.php">
                    ...
                    <input class="tagging" type="submit" name="buttonTagging" id="buttonTagging" value="Tagging" style="margin: 0px 25px 0px 50px; color: white; background: #5bc0de; border-radius: 2px; border: none; font-size: 14px; padding: 8px 35px;" >
                    <input class="sentence" type="submit" name="buttonPastofSentence" id="buttonPastofSentence" value="Simple Sentence" style="margin: 0px 25px 0px 0px;">
                    <input class="translate" type="submit" name="buttonTranslate" id="buttonTranslate" value="Translate" style="margin: 0px 0px 0px 0px;">

                    <textarea class="form-control" id="show" name='showtext' rows='7'>
                     <?php
                        if (isset($_POST["buttonTranslate"])) {
                            include("run_translate.php");
                        } else if (isset($_POST["buttonPastofSentence"])) {
                            include("run_simple_sentence.php");
                        } else if (isset($_POST["buttonTagging"])) {
                            include("run_tagging.php");
                        } else {
                            echo " ";
                        }
                        ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $(document).on('click','tagging', 'sentence', 'translate' ,function(e){
